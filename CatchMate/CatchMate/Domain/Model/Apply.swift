...
struct Apply: Equatable {
    ...
    static var dummyData: [Apply] = [
        Apply(id: "1", post: Post(title: "연패는 안 된다 쉬었잖아 제발", writer: SimpleUser(userId: "1", nickName: "망곰보유구단", picture: "", favGudan: .dosun, gender: .woman, birthDate: "1999-01-01", cheerStyle: .cheerleader), homeTeam: .dosun, awayTeam: .lotte, date: "07.03", playTime: "18:30", location: "잠실", maxPerson: 4, currentPerson: 3, preferAge: [20, 30]), applicant: User(id: "1", email: "ㄴㄴㄴ", nickName: "나요", birth: "2000-01-22", team: .dosun, gener: .man, cheerStyle: .director, profilePicture: nil, pushAgreement: true, description: ""), addText: "나 김치말이 국수 처돌인디"),
        Apply(id: "2", post: Post(title: "주말 홈경기 승률 뭐하냐? 제발 좀 이겨주세요 제발제발요.", writer: SimpleUser(userId: "4", nickName: "꼴등", picture: "", favGudan: .hanhwa, gender: .woman, birthDate: "1998-01-01", cheerStyle: .director), homeTeam: .hanhwa, awayTeam: .kt, date: "07.03", playTime: "18:30", location: "대전", maxPerson: 4, currentPerson: 4, preferAge: [20, 30]), applicant: User(id: "1", email: "ㄴㄴㄴ", nickName: "나요", birth: "2000-01-22", team: .dosun, gener: .man, cheerStyle: .director, profilePicture: nil, pushAgreement: true, description: ""), addText: "오늘 지면 얘네 줘팸"),
        Apply(id: "3", post: Post(title: "도영아 너땜시 살어야", writer: SimpleUser(userId: "7", nickName: "도영아 사랑해", picture: "", favGudan: .kia, gender: .woman, birthDate: "2000-02-02", cheerStyle: .mom), homeTeam: .samsung, awayTeam: .kia, date: "07.03", playTime: "18:30", location: "대구", maxPerson: 3, currentPerson: 2, preferAge: [20, 30]), applicant: User(id: "1", email: "ㄴㄴㄴ", nickName: "나요", birth: "2000-01-22", team: .dosun, gener: .man, cheerStyle: .director, profilePicture: nil, pushAgreement: true, description: ""), addText: "김도영 30-30 보러 가즈아")
    ]
    
    static var recevieDummyData: [[Apply]] = [
        [Apply(id: "11", post: Post(title: "삼성 파랑 뺏으러 가자~", writer: SimpleUser(userId: "1", nickName: "나요", picture: "", favGudan: .hanhwa, gender: .man, birthDate: "2000-01-22", cheerStyle: .cheerleader), homeTeam: .samsung, awayTeam: .hanhwa, date: "08.08", playTime: "18:30", location: "대구", maxPerson: 3, currentPerson: 1), applicant: User(id: "111", email: "email1", nickName: "파란이글스", birth: "1999-01-01", team: .hanhwa, gener: .man, cheerStyle: .cheerleader, profilePicture: "https://ifh.cc/g/MF3ZhH.jpg", pushAgreement: true, description: ""), addText: "저는 파란피가 흐릅니다"),
         Apply(id: "11", post: Post(title: "삼성 파랑 뺏으러 가자~", writer: SimpleUser(userId: "1", nickName: "나요", picture: "", favGudan: .hanhwa, gender: .man, birthDate: "2000-01-22", cheerStyle: .cheerleader), homeTeam: .samsung, awayTeam: .hanhwa, date: "08.08", playTime: "18:30", location: "대구", maxPerson: 3, currentPerson: 1), applicant: User(id: "113", email: "email1", nickName: "보살", birth: "1999-01-01", team: .hanhwa, gener: .man, cheerStyle: .bodhisattva, profilePicture: "https://img.mbn.co.kr/filewww/news/other/2016/09/27/000109006000.jpg", pushAgreement: true, description: ""), addText: "가을 야구 가나요?"),
         Apply(id: "11", post: Post(title: "삼성 파랑 뺏으러 가자~", writer: SimpleUser(userId: "1", nickName: "나요", picture: "", favGudan: .hanhwa, gender: .man, birthDate: "2000-01-22", cheerStyle: .cheerleader), homeTeam: .samsung, awayTeam: .hanhwa, date: "08.08", playTime: "18:30", location: "대구", maxPerson: 3, currentPerson: 1), applicant:  User(id: "112", email: "email1", nickName: "네네치킨", birth: "1999-01-01", team: .hanhwa, gener: .man, cheerStyle: .silent, profilePicture: "https://nenechicken.com/17_new/images/menu/30001.jpg", pushAgreement: true, description: ""), addText: "직관 승률 0"),
         Apply(id: "11", post: Post(title: "삼성 파랑 뺏으러 가자~", writer: SimpleUser(userId: "1", nickName: "나요", picture: "", favGudan: .hanhwa, gender: .man, birthDate: "2000-01-22", cheerStyle: .cheerleader), homeTeam: .samsung, awayTeam: .hanhwa, date: "08.08", playTime: "18:30", location: "대구", maxPerson: 3, currentPerson: 1), applicant: User(id: "114", email: "email1", nickName: "동주맘", birth: "1995-01-01", team: .hanhwa, gener: .woman, cheerStyle: .mom, profilePicture: "https://img.hankyung.com/photo/202311/PYH2023100208470001300_P4.jpg", pushAgreement: true, description: ""), addText: "동주야 사랑해~"),
        ],
