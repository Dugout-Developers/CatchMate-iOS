...
struct Apply: Equatable {
    ...
    static var dummyData: [Apply] = [
        ...
        Apply(id: "3", post: Post(title: "도영아 너땜시 살어야", writer: SimpleUser(userId: "7", nickName: "도영아 사랑해", picture: "", favGudan: .kia, gender: .woman, birthDate: "2000-02-02", cheerStyle: .mom), homeTeam: .samsung, awayTeam: .kia, cheerTeam: .kia, date: "07.03", playTime: "18:30", location: "대구", maxPerson: 3, currentPerson: 2, preferAge: [20, 30], addInfo: "추가 정보"), applicant: User(id: "1", email: "ㄴㄴㄴ", nickName: "나요", birth: "2000-01-22", team: .dosun, gener: .man, cheerStyle: .director, profilePicture: nil, pushAgreement: true, description: ""), addText: "김도영 30-30 보러 가즈아")
    ]
