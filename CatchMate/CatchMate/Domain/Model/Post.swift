...
extension Post {
    static var dummyPostData: [Post] = [
        ...
        Post(title: "2등만 팬다", writer: User(snsID: "aa", email: "aa@aa.com", nickName: "실책 1위", age: 25, team: .kia, gener: .man, cheerStyle: .director, profilePicture: nil), homeTeam: .samsung, awayTeam: .kia, date: "07.03", playTime: "18:30", location: "대구", maxPerson: 2, currentPerson: 1, preferAge: [20, 30]),
