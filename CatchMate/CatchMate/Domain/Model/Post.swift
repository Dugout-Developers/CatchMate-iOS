...
extension Post {
    static var dummyPostData: [Post] = [
        ...
        Post(title: "돌고 돌아 류현진", writer: User(id: "1", snsID: "aa", email: "aa@aa.com", nickName: "치킨", age: 25, team: .hanhwa, gener: .woman, cheerStyle: .director, profilePicture: nil), homeTeam: .hanhwa, awayTeam: .kt, date: "07.03", playTime: "18:30", location: "대전", maxPerson: 4, currentPerson: 3, preferAge: [20, 30]),
        Post(title: "홈경기 드가자", writer: User(id: "1", snsID: "aa", email: "aa@aa.com", nickName: "꼴등", age: 25, team: .hanhwa, gener: .woman, cheerStyle: .director, profilePicture: nil), homeTeam: .hanhwa, awayTeam: .kt, date: "07.03", playTime: "18:30", location: "대전", maxPerson: 4, currentPerson: 4, preferAge: [20, 30]),
