...
final class TabBarController: UITabBarController, UITabBarControllerDelegate, View {
    ...
    private func settupTabbar() {
        ...
        favoriteViewController.tabBarItem = UITabBarItem(title: "관심", image: UIImage(named: "cmFavorite")?.withTintColor(.grayScale200, renderingMode: .alwaysOriginal), selectedImage: UIImage(named: "cmFavorite_filled")?.withRenderingMode(.alwaysOriginal))
